...
___DECLARE_TYPE_WRAPPER_INHERITANCE(RandomShit::UI, SettingsUI, Il2CppTypeEnum::IL2CPP_TYPE_CLASS, Il2CppObject,
                                    "RandomShit::UI", SETTINGSUI_INTERFACES, 0, nullptr,
                                    DECLARE_PRIVATE_FIELD(::GlobalNamespace::MainFlowCoordinator *, _mainFlowCoordinator);
                                            DECLARE_PRIVATE_FIELD(::RandomShit::UI::FlowCoordinators::SettingsFlowCoordinator *, _settingsFlowCoordinator);
