...
DECLARE_CLASS_CODEGEN(RandomShit::UI::FlowCoordinators, SettingsFlowCoordinator, ::HMUI::FlowCoordinator,
                      DECLARE_PRIVATE_FIELD(::GlobalNamespace::MainFlowCoordinator *, _mainFlowCoordinator);
                              DECLARE_PRIVATE_FIELD(::RandomShit::UI::ViewControllers::SettingsViewController *, _settingsViewController);
